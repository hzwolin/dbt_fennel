...
adding_features AS (
        SELECT 
            *
            ...
            ,(CASE WHEN max_temp_c < 20 and > 30 THEN 0 ELSE 1 END) AS good_temp
            ,(CASE WHEN avg_temp_c > 20 THEN 1 ELSE 0 END) AS good_avg
            ,(CASE WHEN total_precip_mm = 0 THEN 1 ELSE 0 END) no_rain
            ,(CASE WHEN daily_will_it_rain = 0 THEN 1 ELSE 0 END) good_rain
            ,(CASE WHEN max_wind_kph > 5 and < 12 THEN 1 ELSE 0 END) good_wind
            ,(CASE WHEN avg_vis_km > 8 THEN 1 ELSE 0 END) good_vis
            ,(CASE WHEN uv >= 3 THEN 1 ELSE 0 END) sunscreen_needed
